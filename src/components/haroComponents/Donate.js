    ...
    return (
      <section id="donate" className="container content-section text-center">
        <div className='section-content'>
                  ...
                  <h4 className="section-heading">Charity of the Month</h4>
